...
Using `cor(...)` we see that also here the correlation is `r cor(businesses$dist, businesses$rating, use="complete")`, which is neglible.
...
The correlation is `r cor(businesses$dist, businesses$review_count, use="complete")`, which again, is neglible.
